...
import { ProxyManualDialog } from "@director.run/design/components/workspaces/workspace-manual-connection-dialog.tsx";
import type { Meta, StoryObj } from "@storybook/react";
import { useState } from "react";

const meta = {
  title: "components/proxies/proxy-manual-dialog",
